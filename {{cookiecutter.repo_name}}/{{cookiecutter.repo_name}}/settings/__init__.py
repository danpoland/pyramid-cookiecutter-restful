...
PYRAMID_APP_SETTINGS['sqlalchemy.url'] = '{URL_SCHEMA}://{USER}:{PASSWORD}@{HOST}:{PORT}/{NAME}'.format(**DATABASE)
PYRAMID_APP_SETTINGS['sqlalchemy.connect_args'] = DATABASE.get('OPTIONS', {})
